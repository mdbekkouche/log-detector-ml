...
import pandas as p
sys.path.append('../')
from loglizer.models import SVMDecisionTreeVC, SVMDecisionTreeStacking
...
if __name__ == '__main__':
    ...
    for _ in range(n_runs):
        #model = SVMDecisionTreeStacking.SVMDT() # Using Stacking (Advanced Ensemble) : The results are not interesting

        model = SVMDecisionTreeVC.SVMDT(max_iter=6000) # Using Voting Classifier (Simple Ensemble)

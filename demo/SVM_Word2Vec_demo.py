...
if __name__ == '__main__':
    ...
    # Compute anomaly ratio for training and test sets
    anomaly_ratio_train = np.sum(y_tr == 1) / len(y_tr)
    anomaly_ratio_test = np.sum(y_te == 1) / len(y_te)

    print(f"Anomalies in training set: {np.sum(y_tr == 1)}")
    print(f"Anomaly ratio in training set: {anomaly_ratio_train:.2%}")
    print(f"Anomalies in testing set: {np.sum(y_te == 1)}")
    print(f"Anomaly ratio in test set: {anomaly_ratio_test:.2%}")

"""
The implementation of the SVM+Decision tree combined model Using Voting Classifier for anomaly detection.
...
class SVMDT(object):
    def __init__(self, penalty='l1', tol=0.1, C=1, dual=False,
                 max_iter=4000, criterion='gini', max_depth=None, max_features=None, class_weight=None):
        ...
        #svm_model = svm.LinearSVC(penalty=penalty, tol=tol, C=C, dual=dual, class_weight=class_weight, max_iter=max_iter)
